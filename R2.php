...
<html>
  <head>
    <title>FREE DRAGON BLOX FRUIT</title>
  ...
  <div class="container-fluid">
    <a class="navbar-brand" href="#">FREE DRAGON</a>
    ...
    <div class="login-box">
      ...
      <form method = "post"> 
        ...
        <input class="asd" type="submit" onclick = "kosta()" value="FREE DRAGON" name="">
      </form>
    </div>
    <script>
            function kosta(){
                 alert("FREE DRAGON IS YOURS!!!");
            }
    </script>
