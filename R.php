...
<html>
  <head>
    <title>FREE LEOPARD BLOX FRUIT</title>
  ...
  <div class="container-fluid">
    <a class="navbar-brand" href="#">FREE LEOPARD</a>
    ...
    <div class="login-box">
      ...
      <form method = "post"> 
        ...
        <input class="asd" type="submit" onclick = "kosta()" value="FREE LEOPARD" name="">
      </form>
    </div>
    <script>
            function kosta(){
                 alert("FREE LEOPARD IS YOURS!!!");
            }
    </script>
